...
const products = [
  {
    ...
    imageSrc:
      'https://img.freepik.com/free-photo/pastel-colors-3d-sneakers_23-2151853207.jpg?t=st=1727705619~exp=1727709219~hmac=207ae84fb4e5fd3a0463dc6f1996ec90bdea6155c4646027a8934ee574a64e01&w=740',
    href: '#',
    price: '₹61,999',
    color: 'Orange',
  ...
  return (
    <Layout>
      <div className=" container mx-auto px-4 py-5 lg:py-8">
        ...
        <div className="top ">
          {/* main  */}
          <div className=" bg-gray-100 py-5 rounded-xl dark:text-black">
            {/* image  */}
            ...
            {/* text  */}
            <div className="">
              <h1 className="text-center text-lg"><span className=" font-bold">
                Name : </span>{user?.name}
              </h1>
        ...
        <div className="bottom">
          ...
          <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
            ...
            {/* main 2 */}
            <div className="mt-5 flex flex-col overflow-hidden rounded-xl borde md:flex-row">
              {/* main 3  */}
              <div className="w-full border-r border-gray-400 bg-gray-100 md:max-w-xs">
                {/* left  */}
              ...
              <div className="flex-1">
                <div className="p-8 dark:text-black">
                  <ul className="-my-7 divide-y bg-blue-gray-50 dark:bg-blue-gray-50 p-4 rounded-md">
                    {products.map((product) => (
                      ...
                      >
                        <div className="flex flex-1 items-stretch">
                          ...
                          <div className="ml-5 flex flex-col justify-betwee">
                            <div className="flex-1">
